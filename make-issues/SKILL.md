...
- `assets/labels.yaml` -- the label scheme (provenance, autonomy, reconciliation flags, `src:` version stamps) and the meta-block contract. Traceability is carried in the issue body, not as labels. Read it before ensuring labels or writing the meta block.
